...
% Last Modified by GUIDE v2.5 20-Mar-2023 11:22:23
...
% handles    structure with handles and user data (see GUIDATA)
global train 
matlabpath ='C:\Users\USER PC\Dropbox\PC\Downloads\crop\crop'
...
layers = [ imageInputLayer([236 281 1])
...
train = imageDatastore(data, 'IncludeSubfolders',true,'LabelSource','foldernames');
train = augmentedImageDatastore([236 281],train,'ColorPreprocessing', 'rgb2gray');
